$(function () {
    ...
    $(".search-tabs a").click(function (e) {
        ...
        //$(".work_type").val($(this).attr("value"));
        $(".work_search").attr("action",$(this).attr("value"));
    });
    ...
    var ttabs = $(".ttabs > a");
    var ttabsContent = $(".ttabs-content > div");

    ttabs.click(function (e) {
        e.preventDefault();
        var th = $(this);
        var index = ttabs.index(th);

        ttabs.removeClass("active");
        th.addClass("active");

        ttabsContent.removeClass("active");
        ttabsContent.filter(":eq(" + index + ")").addClass("active");
    ...
    $(".eye").click(function (e) {
        e.preventDefault();
        var passInput = $(this).closest("li").find("input");
    ...
    {
        $(".ttabs a:nth-child(2)").click();
    }
    else if(window.location.hash == "#balance")
    {
        $(".ttabs a:nth-child(3)").click();
    }
    else if(window.location.hash == "#items")
    {
        $(".ttabs a:nth-child(1)").click();
    }
    else
    {
        $(".ttabs a:nth-child(2)").click();
    ...
    function checkbox(selector) {
        ...
        $.each(collect, function (i, n) {
            ...
            parentDiv.click(function (e) {
                $(".toolbox .ch-checkbox").each(function(){
                ...
                window.location.href = check.attr("value");
            })
